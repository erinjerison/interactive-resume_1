...
Don't worry, you'll learn what's going on in this file throughout the course. You won't need to make any changes to it until you start experimenting with inserting a Google Map in Problem Set3.
Cameron Pittman
*/
...
*/
var HTMLheaderName = '<p /><h1 id="name">%data%</h1>';
var HTMLheaderRole = '<p /><span class="role">%data%</span><hr/>';
...
var HTMLprojectImage = '<img src="%data%" class="img-rounded">';
...
var HTMLrefStart = '<div class="reference-entry"></div>';
var HTMLrefName = '<a href="#">%data%';
var HTMLrefTitle = '%data%</a>';
var HTMLrefCompany = '<p><br>%data%</p>';
var HTMLrefText = '<p class="reference-text"><br>%data%</p>';
	...
	*/
	function createMapMarker(placeData) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			// open infowindow when user clicks a location
			var openInfo = infoWindow.open(map, marker);
			openInfo();
		});
